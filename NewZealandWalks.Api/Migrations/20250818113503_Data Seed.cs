    ...
    public partial class DataSeed : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("61174870-25ec-481d-a951-c59a1741fb44"), "Hard" },
                    { new Guid("89607ac1-90dd-4093-8cfe-3ec1c30ee0a6"), "Easy" },
                    { new Guid("f919654c-69cd-456d-9392-d21202ba798d"), "Meidum" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("61174870-25ec-481d-a951-c59a1741fb44"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("89607ac1-90dd-4093-8cfe-3ec1c30ee0a6"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("f919654c-69cd-456d-9392-d21202ba798d"));
